...
class FM(torch.nn.Module):
    ...
    def __init__(self, opt):
        ...
        # Initialize uniform embeddings instead of PEP embeddings
        self.embedding = nn.Embedding(self.feature_num, self.latent_dim)
        ...
        self.EmbeddingParameters = self.feature_num * self.latent_dim
    ...
    def calc_sparsity(self):
        ...
        # Count non-zero elements in the embedding weight
        non_zero_values = torch.count_nonzero(self.embedding.weight).item()
        percentage = 1 - (non_zero_values / base)
        return percentage, non_zero_values
    def get_embedding(self):
        # Return the embedding weights as a numpy array
